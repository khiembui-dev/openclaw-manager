 ...
 * Domain points to OpenClaw Gateway UI (port 18789).
 * Manager is accessed separately via IP:3847.
 */
async function setupNginx(domain, gatewayPort, email, logFn) {
  ...
  // Nginx config - proxy to OpenClaw Gateway (port 18789)
  const nginxConf = `# OpenClaw Gateway - ${domain}
# Generated by OpenClaw Manager
# OpenClaw UI: port ${gatewayPort} | Manager: IP:3847
